...
- **Endpoint**：`POST https://app-d2y8vp5n1s75-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-d2y8vp5n1s75-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
